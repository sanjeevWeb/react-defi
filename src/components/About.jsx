                ...
                <div className='max-w-[1240px] mx-auto px-4 py-16'>
                    <div>
                        ...
                        <p className='py-4 text-xl'>
                            The Defi protocol  system empowers developers,liquidity providers,and traders to participate in a
                            financial marketplace that is open and accesible to all.
                        </p>

                        {/* card container */}
                        <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-4'>
                            <AboutCard icon={<SiHiveBlockchain size={40} />} heading='Reliable,temper-proof network' text='Use decentralization, 
                            trusted nodes, premium data, and cryptographics proof to connect highly accurate
                             and available data/API to any smart contract'/>
